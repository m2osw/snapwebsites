 ...
 * Browsers: all
 * Depends: ...
 * Copyright: Copyright (c) 2019  Made to Order Software Corp.  All Rights Reserved
 * License: GPL 2.0
 */
 ...
 *
 * @return {!snapwebsites.Index}  This object once initialized.
 *
 * @constructor
 * @struct
 */
snapwebsites.Index = function()
{
    this.constructor = snapwebsites.Index;

    return this;
};


/** \brief Mark Index as a base class.
 *
 * This class does not inherit from any other classes.
 */
snapwebsites.base(snapwebsites.Index);
...
jQuery(document).ready(
    function()
    {
        snapwebsites.IndexInstance = new snapwebsites.Index();
    }
);
