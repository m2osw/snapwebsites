...
Copyright (c) 2015-2017  Alexis Wilke <https://snapwebsites.org/>
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <div id="footer">
          <p>Generated by the <a href="https://snapwebsites.org/" target="_blank">Snap! Websites</a> core plugins.</p>
        </div>
      </body>
    </html>
  </xsl:template>
