...
void backend::bootstrap(snap_child * snap)
{
    ...
    SNAP_LISTEN  ( backend, "server", snap_manager::manager, retrieve_status,        boost::placeholders::_1     );
    SNAP_LISTEN  ( backend, "server", snap_manager::manager, add_plugin_commands,    boost::placeholders::_1     );
    SNAP_LISTEN  ( backend, "server", snap_manager::manager, process_plugin_message, boost::placeholders::_1, boost::placeholders::_2 );
