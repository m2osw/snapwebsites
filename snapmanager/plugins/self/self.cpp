...
void self::bootstrap(snap_child * snap)
{
    ...
    SNAP_LISTEN  ( self, "server", snap_manager::manager, retrieve_status,          boost::placeholders::_1     );
    SNAP_LISTEN  ( self, "server", snap_manager::manager, add_plugin_commands,      boost::placeholders::_1     );
    SNAP_LISTEN  ( self, "server", snap_manager::manager, process_plugin_message,   boost::placeholders::_1, boost::placeholders::_2 );
}
                       ...
                       , std::set<QString> & affected_services)
{
    ...
    {
        snapdev::NOT_USED(f_snap->upgrader());
    ...
    if(field_name == "snapmanager_frontend")
    {
        ...
        //
        snapdev::NOT_USED(f_snap->replace_configuration_value("/etc/snapwebsites/snapwebsites.d/snapmanager.conf", field_name, value));
        return true;
    }
    ...
    if(field_name == "redirect_unwanted")
    {
        ...
        //
        snapdev::NOT_USED(f_snap->replace_configuration_value("/etc/snapwebsites/snapwebsites.d/snapmanager.conf", field_name, new_value));
        return true;
    }
