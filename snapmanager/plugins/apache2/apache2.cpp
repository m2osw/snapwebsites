...
void apache2::bootstrap(snap_child * snap)
{
    ...
    SNAP_LISTEN  ( apache2, "server", snap_manager::manager, retrieve_status,          boost::placeholders::_1     );
    SNAP_LISTEN  ( apache2, "server", snap_manager::manager, handle_affected_services, boost::placeholders::_1     );
}
